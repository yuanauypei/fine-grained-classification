    ...
    if datasetname is not None:
        ...
        if datasetname == "cubbirds":
            ...
            for line in traindata:
                ...
                train_src_path = osp.join("/home/zhuyuan/zy_all/datasets_all/stanford_cars/", line['relative_im_path'])
            ...
            for line in testdata:
                ...
                test_src_path = osp.join("/home/zhuyuan/zy_all/datasets_all/stanford_cars/", line['relative_im_path'])
                class_name = class_dict[line['class']]
            ...
            for imgpath in train_data:
                ...
                train_src_path = osp.join("/home/zhuyuan/zy_all/datasets_all/Stanford_Dogs/", 'Images', imgpath)
                trainval_dst_path = osp.join(trainvalpath, class_name)
                shutil.copy(train_src_path, trainval_dst_path)
            for imgpath in test_data:
                class_name = imgpath.split('/')[0]
                test_src_path = osp.join("/home/zhuyuan/zy_all/datasets_all/Stanford_Dogs/", 'Images', imgpath)
                test_dst_path = osp.join(testpath, class_name)
                shutil.copy(test_src_path, test_dst_path)
            ...
            for row in traindata:
                img_src_path = osp.join("/home/zhuyuan/zy_all/datasets_all/FGVC-Aircraft/fgvc-aircraft-2013b/data/", 'images', row[0]+'.jpg')
