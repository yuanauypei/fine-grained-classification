...
progpath = "/home/zhuyuan/zy_all/datasets_all/FGVC-Aircraft/fgvc-aircraft-2013b/data"
save_path = "/home/zhuyuan/zy_all/SEF-master/datasets/vggaircraft/"
sys.path.append(save_path)


imdbpath = osp.join(save_path, "imdb.pkl")

if not os.path.exists(imdbpath):

    # variant
    train_variant_list = "images_variant_train.txt"
    val_variant_list = "images_variant_val.txt"
    trainval_variant_list = "images_variant_trainval.txt"
    test_variant_list = "images_variant_test.txt"

    # family
    train_family_list = "images_family_train.txt"
    val_family_list = "images_family_val.txt"
    trainval_family_list = "images_family_trainval.txt"
    test_family_list = "images_family_test.txt"

    # manufacturer
    train_manufacturer_list = "images_manufacturer_train.txt"
    val_manufacturer_list = "images_manufacturer_val.txt"
    trainval_manufacturer_list = "images_manufacturer_trainval.txt"
    test_manufacturer_list = "images_manufacturer_test.txt"

    variants_list = "variants.txt"
    families_list = "families.txt"
    manufacturers_list = "manufacturers.txt"
    ...
    with open(os.path.join(save_path, 'imdb.pkl'), 'wb') as handle:
    ...
    with open(os.path.join(save_path, 'imdb.pkl'), 'rb') as handle:
